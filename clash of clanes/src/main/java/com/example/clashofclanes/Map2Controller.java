...
public class Map2Controller implements Initializable {
    ...
    public void setBuildings() {
        ...
        BlackWall treeBlackWall = new BlackWall("normal", 130, 10, blackWall3_img, blackWall3_img.getLayoutX(), blackWall3_img.getLayoutY());
        ...
        ArcherBuilding archerBuilding2 = new ArcherBuilding("Defensive", 150, 15, archerBuilding1_img, archerBuilding1_img.getLayoutX(), archerBuilding1_img.getLayoutY());
        ...
        Map1.root.getChildren().add(treeBlackWall);
...
//        System.out.println("number grand" + numberOfGrand);
    ...
    public static ImageView makeCopy(String path, ImageView imageView, double x, double y) {
        ...
        Map2.root.getChildren().add(imageView);
    ...
    void click_Wizard(MouseEvent event) {
        if (counterWizard < numberOfWizard) {
            ...
            Map2.root.getChildren().add(shotObject);
    ...
    void click_Archer(MouseEvent event) {
        ...
        if (counterArcher < numberOfArcher) {
            ...
            Map2.root.getChildren().add(archer_queen);
            Map2.root.getChildren().add(shotArcherObject);
...
//            rotate.play();
    ...
    void click_Barbarian(MouseEvent event) {
        ...
        if (counterBarbarian < numberOfBarbarian) {
            ...
            Map2.root.getChildren().add(barbarianKing2);
            Map2.root.getChildren().add(shotBarbarianObject);
    ...
    void click_Grand(MouseEvent event) {
        if (counterGrand < numberOfGrand) {
            ...
            Map2.root.getChildren().add(grandWarden2);
            draggedHero.add(grandWarden2);
            Map2.root.getChildren().add(shotGrandObject);
